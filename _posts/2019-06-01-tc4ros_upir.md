...
<figure>
    ...
    <figcaption style="text-align: center;">Some `new_connection` events. Highlighted are two events belonging to the same connection, but opposite endpoints.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption style="text-align: center;">Graph generated using `rqt_graph`.</figcaption>
</figure>
