...
<figure>
    ...
    <figcaption>Outcome of this project: message flow analysis.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>Some `new_connection` events. Highlighted are two events belonging to the same connection, but opposite endpoints.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>View showing the state of a publisher queue. At this timestamp (thin blue vertical line), the first message is removed from the queue and sent to the subscriber.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>Graph generated using `rqt_graph`.</figcaption>
</figure>
